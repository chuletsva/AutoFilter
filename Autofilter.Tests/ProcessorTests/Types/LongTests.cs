...
public class LongTests
{
    ...
    public static IEnumerable<object[]> LongTestCases => new[]
    {
        ...
        new object[] { 0L, new[] { "0" }, SearchOperator.InRange, true },
        new object[] { 0L, new[] { "1" }, SearchOperator.InRange, false },
        new object[] { 0L, Array.Empty<string?>(), SearchOperator.InRange, false },
    };
