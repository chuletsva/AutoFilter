...
public class FloatTests
{
    ...
    public static IEnumerable<object[]> FloatTestCases => new[]
    {
        ...
        new object[] { 0F, new[] { "0" }, SearchOperator.InRange, true },
        new object[] { 0F, new[] { "1" }, SearchOperator.InRange, false },
        new object[] { 0F, Array.Empty<string?>(), SearchOperator.InRange, false },
    };
